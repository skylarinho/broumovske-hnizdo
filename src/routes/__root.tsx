...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ac5ty9mFhaefsxDbB2EaCx097KX2/social-images/social-1778149434685-hnizdo_meta.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/ac5ty9mFhaefsxDbB2EaCx097KX2/social-images/social-1778149434685-hnizdo_meta.webp" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/favicon-dark.png" },
      { rel: "apple-touch-icon", href: "/favicon-dark.png" },
    ],
  }),
