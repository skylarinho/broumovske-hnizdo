...
const pois = [
  { icon: ParkingSquare, name: { cs: "Parkování", en: "Parking" }, distance: "u domu", longDesc: { cs: "Veřejné parkoviště přímo u domu, místa bývají i večer. Bez poplatku.", en: "Public parking right by the house, usually free spots even in the evening." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: ShoppingBasket, name: { cs: "Lidl", en: "Lidl" }, distance: "100 m", longDesc: { cs: "Otevřeno denně, stačí přejít ulici. Ideální pro rychlý nákup snídaně nebo večeře.", en: "Open daily, just across the street. Perfect for a quick breakfast or dinner run." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Landmark, name: { cs: "Klášter Broumov", en: "Broumov Monastery" }, distance: "100 m", longDesc: { cs: "Jeden z nejvýznamnějších barokních klášterů u nás. Prohlídky, kavárna, výstavy a krásná zahrada.", en: "One of the most important Baroque monasteries in the country. Tours, café, exhibitions and a lovely garden." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  ...
  { icon: Coffee, name: { cs: "Café Dientzenhofer", en: "Café Dientzenhofer" }, distance: "150 m", longDesc: { cs: "Na pořádnou kávu v příjemném prostředí u kláštera.", en: "For a proper coffee in a nice spot near the monastery." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: UtensilsCrossed, name: { cs: "Restaurace U Kostela", en: "U Kostela Restaurant" }, distance: "250 m", longDesc: { cs: "Když máš pořádný hlad po výletu – sem se vejde i druhá večeře. Mega porce.", en: "When you're seriously hungry after a hike — portions are massive." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: UtensilsCrossed, name: { cs: "Restaurace Lokál", en: "Lokál" }, distance: "300 m", longDesc: { cs: "Klasická česká kuchyně, příjemná obsluha, občas i koncert. Doporučuji rezervaci.", en: "Czech classics, friendly service, occasional live music. Booking recommended." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Banknote, name: { cs: "Bankomaty Moneta, ČS, ČSOB", en: "ATMs Moneta, ČS, ČSOB" }, distance: "350 m", longDesc: { cs: "Tři bankomaty pohromadě na broumovském náměstí.", en: "Three ATMs together on Broumov's main square." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: UtensilsCrossed, name: { cs: "Café Restaurant Domíno", en: "Café Restaurant Domíno" }, distance: "350 m", longDesc: { cs: "Když máš chuť na topinku a Krakonoše. Klasika.", en: "Go for a topinka and a Krakonoš beer. Classic." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Beer, name: { cs: "Alka – Bar Restaurant", en: "Alka – Bar Restaurant" }, distance: "400 m", longDesc: { cs: "Tankové pivo, teplá kuchyně a sportovní přenosy. Když chceš zápas s pivem v ruce.", en: "Tank beer, hot food and live sports broadcasts." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Beer, name: { cs: "U tří růží", en: "U tří růží" }, distance: "400 m", longDesc: { cs: "Místní hospůdka s broumovským Opatem a poctivými jídly. Atmosféra jako z minulého století.", en: "Local pub with Broumov's Opat beer and hearty meals. Old-school atmosphere." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Milk, name: { cs: "Braunaer – Sýrárna Broumov", en: "Braunaer – Broumov Cheese Dairy" }, distance: "500 m", longDesc: { cs: "Místní sýrárna s broumovskými sýry – skvělý dárek nebo svačina na výlet.", en: "Local cheese dairy with Broumov cheeses — great gift or hiking snack." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Martini, name: { cs: "Bar Terno", en: "Bar Terno" }, distance: "500 m", longDesc: { cs: "Legendární bar za zvonkem, kam se místní přesouvají po desáté — ať už za hudbou nebo kartami.", en: "Legendary bar (ring the bell) where locals move after 10pm — for music or cards." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: TrainFront, name: { cs: "Železniční zastávka", en: "Train station" }, distance: "600 m", longDesc: { cs: "Vlakové spojení do Náchoda, Hradce Králové i dál.", en: "Train connections to Náchod, Hradec Králové and beyond." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Church, name: { cs: "Dřevěný kostel", en: "Wooden church" }, distance: "1,5 km", longDesc: { cs: "Hřbitovní kostel Panny Marie ze 14. století – unikátní dřevěná stavba, kterou nesmíš minout.", en: "14th-century wooden cemetery church — a unique landmark you shouldn't miss." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
];
