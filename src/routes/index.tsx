...
const pois = [
  ...
  { icon: ShoppingBasket, name: { cs: "Potraviny u Šafáře", en: "Potraviny u Šafáře (grocery)" }, distance: "5 min", longDesc: { cs: "Must visit! Lokální produkty, skvělý masový pult a super výběr. O víkendu otevřeno do 11:00. Nezapomeň si u pokladny pamatovat číslo košíku.", en: "Must visit! Local products, a great meat counter and excellent selection. Weekends open until 11am. Don't forget to remember your basket number at the till." }, mapy: "https://mapy.cz/zakladni?q=Potraviny+u+%C5%A0af%C3%A1%C5%99e+Broumov", google: "https://www.google.com/maps/search/?api=1&query=Potraviny+u+%C5%A0af%C3%A1%C5%99e+Broumov" },
