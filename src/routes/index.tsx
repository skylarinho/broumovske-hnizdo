...
const pois = [
  ...
  { icon: Bus, name: { cs: "Zastávka Broumov, MěÚ", en: "Bus stop Broumov, MěÚ" }, distance: "100 m", desc: { cs: "Autobus ke všem turistickým cílům.", en: "Buses to all hiking trailheads." }, longDesc: { cs: "Z téhle zastávky se dostaneš autobusem prakticky ke všem turistickým cílům v okolí – Adršpach, Stěny, Police, Machov.", en: "From this stop you can reach almost all hiking destinations in the area by bus." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: UtensilsCrossed, name: { cs: "Restaurace U Kostela", en: "U Kostela Restaurant" }, distance: "", desc: { cs: "Mega porce.", en: "Huge portions." }, longDesc: { cs: "Když máš pořádný hlad po výletu – sem se vejde i druhá večeře.", en: "When you're seriously hungry after a hike — portions are massive." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Beer, name: { cs: "Alka – Bar Restaurant", en: "Alka – Bar Restaurant" }, distance: "", desc: { cs: "Tankové pivo a sportovní přenosy.", en: "Tank beer and live sports." }, longDesc: { cs: "Tankové pivo, teplá kuchyně a sportovní přenosy. Když chceš zápas s pivem v ruce.", en: "Tank beer, hot food and live sports broadcasts." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: TrainFront, name: { cs: "Železniční zastávka", en: "Train station" }, distance: "", desc: { cs: "Vlakem do okolí.", en: "Trains to the region." }, longDesc: { cs: "Vlakové spojení do Náchoda, Hradce Králové i dál.", en: "Train connections to Náchod, Hradec Králové and beyond." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Coffee, name: { cs: "Café Dientzenhofer", en: "Café Dientzenhofer" }, distance: "", desc: { cs: "Káva.", en: "Coffee." }, longDesc: { cs: "Na pořádnou kávu v příjemném prostředí u kláštera.", en: "For a proper coffee in a nice spot near the monastery." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Banknote, name: { cs: "Bankomaty Moneta, ČS, ČSOB", en: "ATMs Moneta, ČS, ČSOB" }, distance: "", desc: { cs: "Všechny na náměstí.", en: "All on the main square." }, longDesc: { cs: "Tři bankomaty pohromadě na broumovském náměstí.", en: "Three ATMs together on Broumov's main square." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: UtensilsCrossed, name: { cs: "Café Restaurant Domíno", en: "Café Restaurant Domíno" }, distance: "", desc: { cs: "Topinka a Krakonoš.", en: "Topinka & Krakonoš beer." }, longDesc: { cs: "Když máš chuť na topinku a Krakonoše. Klasika.", en: "Go for a topinka and a Krakonoš beer. Classic." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
  { icon: Milk, name: { cs: "Braunaer – Sýrárna Broumov", en: "Braunaer – Broumov Cheese Dairy" }, distance: "", desc: { cs: "Místní sýry.", en: "Local cheese." }, longDesc: { cs: "Místní sýrárna s broumovskými sýry – skvělý dárek nebo svačina na výlet.", en: "Local cheese dairy with Broumov cheeses — great gift or hiking snack." }, mapy: "https://mapy.cz/", google: "https://maps.google.com/" },
];
