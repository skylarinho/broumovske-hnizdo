...
import { ArrowRight, MapPin, ParkingSquare, Phone, Coins, Footprints, Mountain, Clock, ExternalLink, ShoppingBasket, Landmark, UtensilsCrossed, Beer, Church, Check, Quote, Martini, Bus, TrainFront, Coffee, Banknote, Milk, Waves, Snowflake, Bike, Dumbbell } from "lucide-react";
...
const pois = [
  ...
  { icon: Mountain, name: { cs: "Lezecká stěna Broumov", en: "Broumov Climbing Wall" }, distance: "1,5 km", longDesc: { cs: "Lezecká stěna v Broumově – ideální pro začátečníky i pokročilé, když nechceš jet do skal.", en: "Climbing wall in Broumov — ideal for beginners and advanced climbers when you don't want to go to the rocks." }, mapy: "https://mapy.cz/zakladni?q=Lezeck%C3%A1+st%C4%9Bna+Broumov", google: "https://www.google.com/maps/search/?api=1&query=Lezeck%C3%A1+st%C4%9Bna+Broumov" },
  { icon: Target, name: { cs: "Střelnice Broumov", en: "Broumov Shooting Range" }, distance: "2 km", longDesc: { cs: "Střelnice v Broumově – možnost si zastřílet pod dohledem instruktora. Vhodné i pro začátečníky, rezervace doporučena.", en: "Shooting range in Broumov — try shooting under instructor supervision. Suitable for beginners too, booking recommended." }, mapy: "https://mapy.cz/zakladni?q=St%C5%99elnice+Broumov", google: "https://www.google.com/maps/search/?api=1&query=St%C5%99elnice+Broumov" },
  ...
  { icon: UtensilsCrossed, name: { cs: "Restaurace Švejk – Centrum Walzel, Meziměstí", en: "Švejk Restaurant – Walzel Centre, Meziměstí" }, distance: "12 km", longDesc: { cs: "Poctivá kuchyně v bývalé Walzelově textilce v Meziměstí. Hlavní důvod zastavit se tady? Dobrý jídlo a příjemné prostředí.", en: "Hearty food in the former Walzel textile mill in Meziměstí. The main reason to stop here? Good food and a pleasant setting." }, mapy: "https://mapy.cz/zakladni?q=Restaurace+%C5%A0vejk+Mezim%C4%9Bst%C3%AD", google: "https://www.google.com/maps/search/?api=1&query=Restaurace+%C5%A0vejk+Mezim%C4%9Bst%C3%AD" },
