...
const pois = [
  ...
  { icon: Coffee, name: { cs: "Café Dientzenhofer", en: "Café Dientzenhofer" }, distance: "150 m", longDesc: { cs: "Na pořádnou kávu v příjemném prostředí u kláštera.", en: "For a proper coffee in a nice spot near the monastery." }, mapy: "https://mapy.cz/zakladni?q=Caf%C3%A9+Dientzenhofer+Broumov&source=firm&id=ChIJPYzBOhZDDkcRW-WiapaJR9I", google: "https://www.google.com/maps/search/?api=1&query=50.5861328,16.3339624" },
