...
const pois = [
  ...
  { icon: Coffee, name: { cs: "Café Herzog", en: "Café Herzog" }, distance: "350 m", longDesc: { cs: "Kavárna přímo na broumovském náměstí – dobrá káva, domácí dorty a příjemné posezení.", en: "A café right on Broumov's main square — good coffee, homemade cakes and a pleasant place to sit." }, mapy: "https://mapy.cz/zakladni?q=Caf%C3%A9+Herzog+Broumov", google: "https://www.google.com/maps/search/?api=1&query=Caf%C3%A9+Herzog+Broumov" },
  ...
  { icon: UtensilsCrossed, name: { cs: "Centrum Walzel – Švejk, střelnice, stěna, Meziměstí", en: "Walzel Centre – Švejk, shooting range, climbing wall, Meziměstí" }, distance: "12 km", longDesc: { cs: "Bývalá Walzelova textilka v Meziměstí. Najdeš tu restauraci Švejk, střelnici i lezeckou stěnu – dobré jídlo i aktivita pod jednou střechou.", en: "The former Walzel textile mill in Meziměstí. Home to Švejk restaurant, a shooting range and a climbing wall — good food and activities under one roof." }, mapy: "https://mapy.cz/zakladni?q=Centrum+Walzel+Mezim%C4%9Bst%C3%AD", google: "https://www.google.com/maps/search/?api=1&query=Centrum+Walzel+Mezim%C4%9Bst%C3%AD" },
